...
const useStyles = makeStyles((theme) => ({
  mainWrapper: {
    backgroundColor: theme.palette.bordabox, //DARK MODE WHATS-GOL//
    display: "flex",
  ...
  newMessageBox: {
    backgroundColor: theme.palette.newmessagebox, //DARK MODE WHATS-GOL//
    width: "100%",
    display: "flex",
    padding: "7px",
    alignItems: "center",
  ...
  messageInputWrapper: {
    padding: 6,
    marginRight: 7,
    backgroundColor: theme.palette.inputdigita, //DARK MODE WHATS-GOL//
    display: "flex",
    borderRadius: 20,
    flex: 1,
  },
